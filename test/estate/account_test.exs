defmodule Estate.AccountTest do
  use Estate.DataCase

  alias Estate.Account
  import Estate.AccountFixtures
  alias Estate.Account.{User, UserToken}
  ...
  describe "get_user!/1" do
    test "raises if id is invalid" do
      assert_raise Ecto.NoResultsError, fn ->
        Account.get_user!("11111111-1111-1111-1111-111111111111")
      end
    end
  ...
  describe "apply_user_email/3" do
    ...
    test "validates email uniqueness", %{user: user} do
      ...
      {:error, changeset} = Account.apply_user_email(user, valid_user_password(), %{email: email})
